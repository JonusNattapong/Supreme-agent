...
- [Using Preme Agent](usage.md) - interactive mode, RLM subagents, slash commands, context files, and CLI reference.
...
- [Skills](skills.md) - markdown and Python-backed skills, including how to ask Preme Agent to create them.
...
- [Preme Agent packages](packages.md) - bundle and share extensions, skills, prompts, and themes.
- [Custom models](models.md) - add model entries for supported provider APIs.
- [Custom providers](custom-provider.md) - implement custom APIs and OAuth flows.

## Programmatic Usage

- [SDK](sdk.md) - embed Preme Agent in Node.js applications.
- [ACP mode](acp.md) - drive Preme Agent from any Agent Client Protocol client.
